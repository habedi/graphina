...
|-----------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|
| [**Centrality**](src/centrality/)       | <ul><li>Degree</li><li>Closeness</li><li>Betweenness (node & edge)</li><li>Eigenvector</li><li>PageRank (standard & personalized)</li><li>Katz</li><li>Harmonic</li><li>Local reaching</li><li>Global reaching</li><li>VoteRank (seed selector)</li><li>Laplacian</li><li><em>Percolation (planned)</em></li></ul>                                                                                                                                                                                                                                                                                                 | Centrality and influence measures                    |
