...
| [**Pool**](src/core/pool.rs)                   | <ul><li>NodeSet pool</li><li>NodeMap pool</li><li>NodeQueue pool</li><li>Thread-local default pools</li></ul>                                                                                                                                         | Experimental (enable with feature `pool`)           |

#### Extensions

| Module                                  | Feature/Algorithm                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Notes                                                               |
|-----------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| [**Centrality**](src/centrality/)       | <ul><li>Degree</li><li>Closeness</li><li>Betweenness (node & edge)</li><li>Eigenvector</li><li>PageRank (standard & personalized)</li><li>Katz</li><li>Harmonic</li><li>Local reaching</li><li>Global reaching</li><li>VoteRank (seed selector)</li><li>Laplacian</li><li><em>Percolation (planned)</em></li></ul>                                                                                                                                                                                                                                                                                                 | Centrality and influence measures (many return <code>Result</code>) |
...
| [**Parallel**](src/parallel/)           | <ul><li>Parallel BFS</li><li>Parallel degree computation</li><li>Parallel clustering coefficients</li><li>Parallel triangles counting</li><li>Parallel PageRank</li><li>Parallel shortest paths</li><li>Parallel connected components</li></ul>                                                                                                                                                                                                                                                                                                                                                                    | Parallel implementations of graph algorithms                        |
| [**Visualization**](src/visualization/) | <ul><li>ASCII art visualization</li><li>Force-directed layout</li><li>Circular layout</li><li>Grid layout</li><li>Hierarchical layout</li><li>HTML generation</li><li>SVG export</li><li>PNG export</li><li>D3.js JSON format</li></ul>                                                                                                                                                                                                                                                                                                                                                                            | Graph visualization and layout algorithms                           |
...
See the [docs](docs/README.md) and [docs.rs/graphina](https://docs.rs/graphina) for full API details.

The memory `pool` module is currently public to allow advanced users to reduce allocation churn.
It may be marked unstable or gated behind a feature in a future release; rely on it cautiously if you need long-term API
stability.

Feature flags enable extension modules:
