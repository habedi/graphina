...
[![Crates.io](https://img.shields.io/crates/v/graphina.svg?style=flat&labelColor=282c34&color=f74c00&logo=rust)](https://crates.io/crates/graphina)
[![Docs.rs](https://img.shields.io/badge/docs.rs-graphina-2b7de9?style=flat&labelColor=282c34&logo=docs.rs)](https://docs.rs/graphina)
[![Docs](https://img.shields.io/badge/docs-read-007ec6?style=flat&labelColor=282c34&logo=readthedocs)](https://habedi.github.io/graphina)
...
Additionally, the [PyGraphina](https://pypi.org/project/pygraphina/) Python library allows using Graphina from Python.
Check out the [pygraphina](pygraphina/README.md) directory for more details.
...
| [**Paths**](src/core/paths.rs)                 | <ul><li>Dijkstra's algorithm</li><li>Bellman-Ford algorithm</li><li>Floyd-Warshall algorithm</li><li>Johnson's algorithm</li><li>A* search algorithm</li></ul>                                                                                                      | Shortest paths algorithms                                 |
...
|-----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|
| [**Centrality**](src/centrality/)       | <ul><li>Degree</li><li>Closeness</li><li>Betweenness (node and edge)</li><li>Eigenvector</li><li>PageRank (standard and personalized)</li><li>Katz</li><li>Harmonic</li><li>Local reaching</li><li>Global reaching</li><li>VoteRank (seed selector)</li><li>Laplacian</li></ul>                                                                                                                                                                                                                                                           | Centrality and influence measures                    |
...
| [**Community**](src/community/)         | <ul><li>Label propagation</li><li>Louvain method</li><li>Girvan-Newman algorithm</li><li>Spectral clustering</li><li>Infomap</li><li>Connected components</li></ul>                                                                                                                                                                                                                                                                                                                                                                       | Community detection and clustering algorithms        |
...
```toml
[dependencies]
graphina = { version = "0.4.0-alpha.7", features = ["centrality", "community", "approximation", "mst", "traversal", "subgraphs", "parallel", "links", "metrics"] }
```
...
See the [documentation](https://habedi.github.io/graphina) and [docs.rs/graphina](https://docs.rs/graphina) for detailed examples and API references.
