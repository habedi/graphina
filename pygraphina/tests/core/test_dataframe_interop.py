...
Tests the to_node_dataframe and to_edge_dataframe functions that
...
class TestNodeDataFrame:
    """Test to_node_dataframe function."""

    def test_pygraph_to_node_dataframe(self):
        """Test exporting PyGraph nodes to DataFrame."""
        g = pg.PyGraph()
        n0 = g.add_node(100)
        n1 = g.add_node(200)
        n2 = g.add_node(300)
    ...
    def test_pydigraph_to_node_dataframe(self):
        """Test exporting PyDiGraph nodes to DataFrame."""
        d = pg.PyDiGraph()
        n0 = d.add_node(10)
        n1 = d.add_node(20)
    ...
    def test_empty_graph_node_dataframe(self):
        """Test exporting empty graph nodes to DataFrame."""
        g = pg.PyGraph()
        df = pg.to_node_dataframe(g)
...
class TestEdgeDataFrame:
    """Test to_edge_dataframe function."""

    def test_pygraph_to_edge_dataframe(self):
        """Test exporting PyGraph edges to DataFrame."""
        g = pg.PyGraph()
        n0 = g.add_node(0)
        n1 = g.add_node(1)
        n2 = g.add_node(2)
    ...
    def test_pydigraph_to_edge_dataframe(self):
        """Test exporting PyDiGraph edges to DataFrame."""
        d = pg.PyDiGraph()
        n0 = d.add_node(0)
        n1 = d.add_node(1)
    ...
    def test_empty_graph_edge_dataframe(self):
        """Test exporting empty graph edges to DataFrame."""
        g = pg.PyGraph()
        g.add_node(0)  # Add nodes but no edges
        g.add_node(1)
        df = pg.to_edge_dataframe(g)
...
class TestDataFrameRoundTrip:
    """Test round-trip conversion between graph and DataFrames."""

    def test_dataframe_preserves_values(self):
        """Test that DataFrame export preserves exact values."""
        g = pg.PyGraph()
        n0 = g.add_node(42)
        n1 = g.add_node(-100)
        n2 = g.add_node(0)
